...
describe('Groups', () => {
	...
	describe('.isMember()', () => {
		...
		it('should return true for uid 0 and_guests group', async () => {
		...
		it('should return true for uid -1 and spiders_group', async () => {
	...
	describe('.create()', () => {
		...
		new Promise((resolve, reject) => {
			Groups.create({
				...
				db.isSortedSetMember('groups:visible:memberCount', 'hidden group', (err, isMember) => {
					if (err) return reject(err);
					try {
						assert(!isMember);
						resolve();
		...
		it('should fail if group name is invalid', () => new Promise((done) => {
		...
		it('should fail if the group name is invalid', async () => {
			try {
		...
		it('should fail if group name is_invalid', () => new Promise((done) => {
			Groups.create({ name: 'not:valid' }, (err) => {
				assert.equal(err.message, '[[error:invalid-group-name]]');
				done();
			});
		...
		it('should return falsy for userTitleEnabled', async () => {
			await Groups.create({ name: 'userTitleEnabledGroup' });
			await Groups.setGroupField('userTitleEnabledGroup', 'userTitleEnabled', 0);
			const data = await Groups.getGroupData('userTitleEnabledGroup');
	...
	describe('.update()', () => {
		...
		it('should change an aspect of a group', () => new Promise((done) => {
		...
		it('should fail if system groups is being renamed', () => new Promise((done) => {
		...
		it('should fail to_rename if group name is invalid', async () => {
			try {
				const slug = await Groups.getGroupField('updateTestGroup?', 'slug');
		...
		it('should fail to rename if group_name is invalid', async () => {
			try {
				const slug = await Groups.getGroupField('updateTestGroup?', 'slug');
		...
		it('should fail to rename if the_group name is invalid', async () => {
			const slug = await Groups.getGroupField('updateTestGroup?', 'slug');
	...
	describe('.destroy()', () => {
		...
		it('should destroy a group', () => new Promise((done) => {
		...
		it('should also remove the members set', () => new Promise((done) => {
	...
	describe('.join()', () => {
		...
		it('should add a user to a group', () => new Promise((done) => {
		...
		it('should add user to multiple groups', () => new Promise((done) => {
		...
		it('should set group title when user joins the group', () => new Promise((done) => {
	...
	describe('.leave()', () => {
		it('should remove a user from a group', () => new Promise((done) => {
	...
	describe('socket/api methods', () => {
		...
		it('should return an error if group name is special', async () => {
			try {
		...
		it('should fail to delete the group if name is special', async () => {
			try {
	...
	describe('api methods', () => {
		...
		it('should fail with invalid_data', async () => {
			let err;
			try {
	...
	describe('groups cover', () => {
		...
		it('should fail if user is not logged in or not owner', () => new Promise((done) => {
		...
		it('should upload group cover image from file', () => {
			const data = {
				groupName: 'Test',
				file: {
					path: imagePath,
		...
		it('should upload group cover image from data', () => new Promise((done) => {
			const data = {
				groupName: 'Test',
		...
		it('should fail to upload group cover with invalid image', () => new Promise((done) => {
			const data = {
				groupName: 'Test',
				file: {
					path: imagePath,
		...
		it('should fail to upload a group cover with invalid image', () => new Promise((done) => {
			const data = {
				groupName: 'Test',
		...
		it('should update group cover position', () => new Promise((done) => {
			const data = {
				groupName: 'Test',
				position: '50% 50%',
			};
		...
		it('should fail to update cover position if group name is missing', () => new Promise((resolve, reject) => {
		...
		it('should fail to remove cover if not logged in', () => new Promise((done) => {
		...
		it('should fail to remove cover if not owner', () => new Promise((done) => {
